...
const modules = [
  {
    title: "Cloud Basics + AWS EC2",
    content: [
      ["What is Cloud? Why AWS?"],
      ["Launch and Connect EC2 (Ubuntu)"],
      ["Host a Static Website via Apache/Nginx"],
      ["Assignment: Launch EC2, configure server, deploy static site"],
      ["Mini Project: Host Your Portfolio Website on EC2"]
    ],
  ...
  },
  {
    ...
    content: [
      ...
      ["IAM Users + Access Control"],
      ["AWS CLI + Access Key Setup"],
      ["Assignment: Create S3 bucket + upload files from CLI"],
      ["Mini Project: Image Hosting Service using S3 + public URLs"]
    ],
    tags: ["Live Classes", "Assignment", "Project"],
    open: false,
  },
  {
    ...
    content: [
      ...
      ["Deploy Dockerized App to EC2"],
      ["Assignment: Dockerize Node App + Push to DockerHub"],
      ["Mini Project: CI/CD Pipeline: GitHub → DockerHub → EC2"]
    ],
    tags: ["Live Classes", "Assignment", "Project"],
    open: false,
  },
  {
    title: "Final Project + Resume Prep",
    content: [
      ["Cloud Architecture Basics"],
      ["Mock Interview Prep + Resume Building"],
      ["Deploying Full App: Frontend + Backend + DB"],
      ["Assignment: Create LinkedIn post sharing your internship journey"],
      ["Final Project: Dockerized MERN App Deployed to EC2 with CI/CD"]
    ],
    tags: ["Live Classes", "Assignment", "Project"],
    open: false,
  },
    ...
    <section className="w-full bg-[#f6f8ff] py-16 px-2 flex flex-col items-center">
      <div className="w-full max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Cloud Computing Course Syllabus</h2>
        ...
        <div className="flex justify-center">
            <Link to="https://rzp.io/rzp/ge1fky8B"><button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg text-lg">Apply Now</button>
</Link>
        </div>
      </div>
    </section>
