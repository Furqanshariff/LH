  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                  Become a Full Stack Developer & Build the Future of Web Apps
                </h1>
                <div className="text-base lg:text-lg font-semibold text-blue-100">
                  Full Stack Development Internships – 4 Weeks
                </div>
            ...
            <div className="flex justify-center items-center -mt-72 z-10 relative">
              <div className="bg-white rounded-[40px] shadow-2xl p-0 max-w-[440px] w-full flex flex-col items-center overflow-hidden">
                <div className="w-full h-auto rounded-t-[40px] overflow-hidden flex items-end justify-end relative p-0 m-0">
                  <img src="/images/image7.jpg" alt="Full Stack Visual" className="w-full h-auto object-cover align-top block p-0 m-0" />
                </div>
      ...
      <section id="online-internship" className="flex justify-center items-center py-16">
        <div className="w-full max-w-6xl bg-black rounded-[48px] px-8 py-12 flex flex-col lg:flex-row gap-10 items-center shadow-xl">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <Link to="https://www.learnyhive.com/courses/full-stack-web-development-internship-program-build-real-world-projects-in-30-days/"><button className="mt-2 px-8 py-3 border-2 border-green-400 text-white rounded-full font-semibold text-lg flex items-center gap-2 hover:bg-green-400 hover:text-black transition-all w-fit">
              Enroll now
      ...
      <section id="offline-internship" className="flex justify-center items-center py-16">
        <div className="w-full max-w-6xl bg-white border-2 border-black rounded-none relative flex flex-col lg:flex-row gap-10 items-center px-8 py-12 shadow-lg" style={{ boxShadow: '8px 8px 0 #2563eb' }}>
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <Link to="https://rzp.io/rzp/cX8xyWt"> <button className="px-8 py-3 border-2 border-black text-black rounded-none font-semibold text-lg bg-white shadow-[4px_4px_0_#000] hover:bg-black hover:text-white transition-all w-fit">Enroll Now</button>
            </Link>
          </div>
          {/* Right: Illustration */}
          <div className="flex-1 flex justify-center items-center">
      ...
      <section id="weekend-internship" className="flex justify-center items-center py-16">
        <div className="w-full max-w-6xl bg-black rounded-[48px] px-8 py-12 flex flex-col lg:flex-row gap-10 items-center shadow-xl">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <Link to="https://rzp.io/rzp/cX8xyWt"><button className="mt-2 px-8 py-3 border-2 border-green-400 text-white rounded-full font-semibold text-lg flex items-center gap-2 hover:bg-green-400 hover:text-black transition-all w-fit">
              Enroll now
              <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M5 12h14M13 6l6 6-6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </button>
            </Link>
      ...
      <section className="w-full bg-gray-50 py-16">
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 max-w-lg">
            <h2 className="text-4xl font-bold mb-6">Who Should Join Full Stack Development Course?</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 bg-white rounded-2xl flex flex-col md:flex-row md:items-center px-6 py-4 gap-4 shadow-md">
                ...
                <Link to="https://rzp.io/rzp/cX8xyWt"><button className="ml-4 bg-[#2563eb] hover:bg-[#1741b6] text-white font-bold px-6 py-2 rounded-xl text-base shadow transition-all">Enroll</button>
                  </Link>
              </div>
            </div>
            {/* Cohort 4 */}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-10">Offline Full-Stack Development Internship</h2>
          <div className="flex flex-col md:flex-row items-center justify-center max-w-4xl mx-auto bg-[#fffbea] rounded-2xl shadow-lg border border-gray-800 overflow-hidden">
            ...
            <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
              ...
              <Link to="https://rzp.io/rzp/cX8xyWt"> <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-lg text-lg mt-2 w-full md:w-auto self-start md:self-auto">Avail Now</button>
</Link>
            </div>
          </div>
        </div>
